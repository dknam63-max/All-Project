...
run(["ffmpeg","-y","-i","vsub.mp4","-i","mix.wav","-map","0:v","-map","1:a","-c:v","copy","-c:a","aac","-b:a","192k","-shortest","/home/user/ACM_02_final2_916.mp4"])
print("DONE", os.path.getsize("/home/user/ACM_02_final2_916.mp4"))
